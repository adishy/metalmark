  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        display: "standalone",
        // Generated by `npm run icons` into public/ and committed, so an
        // install never depends on someone having run a build step. The
        // maskable pair is the same artwork inset into the safe zone — a
        // launcher that crops to a circle gets the whole butterfly and a field
        // that runs to the edge, rather than a clipped wing on a coloured ring.
        icons: [
